...
module.exports = (sequelize, Sequelize) => {
    const Symbols = sequelize.define(
        "Symbols",
        {
            ...
            formulaName: {
                type: Sequelize.ENUM("Any pair/USD", "USD/any pair", "USD/JPY", "JPY/Any pair converted to USD", "Any/Any converted to USD", "Indices", "Crypto/USD", "Crypto/Crypto converted to USD", "Metals to USD"),
                allowNull: false,
            },
        },
        {
